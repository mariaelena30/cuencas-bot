...
EXPLICACIONES = {
    ...
    "tipo_inundacion_dominante": (
        ...
        "ningun rio grande haya subido - es repentino y localizado."
    ),
}
...
CUENCAS: dict = {
    ...
    "rio_negro": {
        ...
        "fuente": "Sin estacion de medicion publica conocida en tiempo real.",
        "conectado": False,
...
localidades: dict = {
    "resistencia": {
        ...
        "influencia_internacional": "Lluvias en el centro-este de Brasil y aporte del rio Paraguay.",
    },
    "barranqueras": {
    ...
    "puerto_bermejo": {
        ...
        "conectado": False, "ultima_verificacion": "2026-08-29",
        "tipo_inundacion_dominante": "fluvial",
        "influencia_internacional": "Cuenca del rio Bermejo: nace en Bolivia y el noroeste argentino.",
    },
    "el_sauzalito": {
        ...
        "conectado": False, "ultima_verificacion": "2026-08-29",
        "tipo_inundacion_dominante": "fluvial",
        "influencia_internacional": "Cuenca del rio Bermejo, compartida con Bolivia y el noroeste argentino.",
    },
    "isla_del_cerrito": {
    ...
    "villa_rio_bermejito": {
        ...
        "conectado": False, "ultima_verificacion": "2026-08-29",
        "tipo_inundacion_dominante": "fluvial",
        "influencia_internacional": "Cuenca del rio Bermejo: nace en Bolivia y Salta.",
    },
    "fuerte_esperanza": {
    ...
    "san_martin_chaco": {
        ...
        "fuente": "Identificada como zona de riesgo pluvial en Gomez et al. (FACENA-UNNE, 2014).",
        "conectado": False, "ultima_verificacion": "2026-08-29",
    ...
    "santa_sylvina": {
        ...
        "fuente": "Evento real documentado: temporal del 07/06/2026.",
    ...
    "quitilipi": {
        ...
        "fuente": "Gobierno provincial anuncio plan integral para prevenir inundaciones en Quitilipi.",
        "conectado": False, "ultima_verificacion": "2026-04-15",
        "tipo_inundacion_dominante": "pluvial",
        "influencia_internacional": None,
    },
...
BARRIOS_VULNERABLES: dict = {
    "victoria_quitilipi": {
        ...
        "lat": -26.8700, "lon": -60.2200, "precision": "aproximada",
        "motivo": "Testimonio de vecino (Higinio Encina, comunidad Qom) - LA NACION.",
        "via_acceso_critica": "Agua estancada sin escurrimiento.",
    },
    "macarena_quitilipi": {
        "nombre": "Barrio Macarena", "localidad_padre": "quitilipi",
        "lat": -26.8700, "lon": -60.2200, "precision": "aproximada",
        "motivo": "Testimonio de vecino (Ruben Alvarenga) - LA NACION.",
        "via_acceso_critica": "Agua estancada sin escurrimiento.",
    },
    "veintidos_agosto_pampa_indio": {
        "nombre": "Barrio 22 de Agosto", "localidad_padre": "pampa_del_indio",
        "lat": -26.0480, "lon": -59.9416, "precision": "aproximada",
        "motivo": "Comunicado oficial del Gobierno del Chaco (24/04/2026): mas de 500 familias asistidas.",
        "via_acceso_critica": "Zona con asistencia via programa Nachec.",
    },
    "ex_cancha_aviacion_pampa_indio": {
        "nombre": "Barrio Ex Cancha de Aviación", "localidad_padre": "pampa_del_indio",
        "lat": -26.0480, "lon": -59.9416, "precision": "aproximada",
        "motivo": "Comunicado oficial del Gobierno del Chaco (24/04/2026).",
        "via_acceso_critica": "Zona con asistencia via programa Nachec.",
    },
    ...
    "pueblo_viejo_puerto_bermejo": {
        ...
        "lat": -26.9064, "lon": -58.5417, "precision": "aproximada",
        "motivo": "Sector historico. Fuente 2016: cedieron las defensas, 100 familias evacuadas.",
        "via_acceso_critica": "Defensas costeras del pueblo viejo.",
    },
    "villa_rio_negro": {
    ...
    "mujeres_argentinas": {
        ...
        "lat": -27.4253, "lon": -58.9764, "precision": "aproximada",
    ...
    "parajes_sauzalito": {
        ...
        "lat": -24.3800, "lon": -61.6200, "precision": "territorial dispersa",
        "motivo": "Cortes recurrentes de caminos por crecientes del río Bermejo.",
...
ESTACIONES_RIO_ARRIBA: dict = {
    "posadas": {
        ...
        "distancia_aprox": "Aguas arriba de Corrientes/Chaco.",
    },
    "santa_ana": {
    ...
    "fuente": "Prefectura Naval Argentina, via CIM-UNL. Verificado 30/08/2026.",
...
# =======================================================================
# PARCHE (14/09/2026) — CUENCAS EN VIVO
#
# ANTES: _cuenca_con_estado() buscaba el dato en vivo en Firestore bajo
# la clave "cuenca_parana" / "cuenca_paraguay" / etc. Nadie escribia
# nunca esa clave, asi que las 4 tarjetas de cuencas del Portal siempre
# mostraban el valor semilla fijo, sin importar cuanto tiempo pasara.
#
# AHORA: cada cuenca usa el dato en vivo de su localidad de referencia
# (misma estacion), que SI se actualiza sola via actualizar_niveles.py.
# =======================================================================
CUENCA_A_LOCALIDAD_REFERENCIA = {
    "parana": "barranqueras",
...
def _cuenca_con_estado(clave: str) -> dict:
    ...
    localidad_referencia = CUENCA_A_LOCALIDAD_REFERENCIA.get(clave)
    if localidad_referencia and localidad_referencia in localidades:
        loc_viva = _localidad_con_estado(localidad_referencia)
        c = {
            **c,
            "nivel_metros": loc_viva["nivel_metros"],
            "conectado": loc_viva["conectado"],
            "ultima_verificacion": loc_viva["ultima_verificacion"],
            "anomalia_velocidad": loc_viva.get("anomalia_velocidad", False),
            "velocidad_m_h": loc_viva.get("velocidad_m_h"),
            "fuente_dato_en_vivo": f"Espejo de la localidad '{localidad_referencia}' (misma estacion)",
        }
    else:
        try:
...
ORGANISMOS: dict = {
    "smn": {
        ...
        "rol": "Pronostico del tiempo y sistema de alerta temprana meteorologica.",
    ...
    "ina": {
        ...
        "nivel": "nacional",
        "dependencia": "Secretaria de Infraestructura y Politica Hidrica",
        "rol": "Pronosticos hidrologicos via SIyAH. Reporta Barranqueras.",
    ...
    "apa": {
        ...
        "rol": "Unica autoridad del agua de la provincia.",
        "url": "http://apachaco.gob.ar/web/index.php",
    },
    "proteccion_civil_chaco": {
        "nombre": "Subsecretaría de Protección Civil",
        "nivel": "provincial (Chaco)",
        "dependencia": "Ministerio de Gobierno y Trabajo",
        "rol": "Coordinacion operativa de emergencias.",
        "url": None,
        "nota": "Verificar nombre vigente antes de citarlo formalmente.",
    },
    "afe": {
        "nombre": "Agencia Federal de Emergencias (AFE)",
        "nivel": "nacional",
        "dependencia": "No confirmado con precision",
        "rol": "Coordina el Plan Federal ENOS 2026-2027.",
        "url": None,
        "nota": "No confirmamos relacion con SINAGIR.",
    },
}
...
CONTEXTO_RELIEVE = {
    "resumen": (
        "Provincia llana, parte de la gran llanura chaco-pampeana. "
        "Pendiente suave de noroeste a sudeste."
    ),
    "fuente": "todo-argentina.net, viajarg.com, Wikipedia - consultados 29/08/2026",
}
